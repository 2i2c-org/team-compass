...
1. In the **Settings** menu, click on **Secrets and Tokens > Actions** in the left-side menu. 
1. Under the *Organization Secrets* section, click on the **`New organization secret`** button.
...
1. Click the *Environment Variables* section in the left sidebar and then click on **`Add Environment Variable`**.
