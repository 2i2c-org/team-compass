...
- How to handle communities with dedicated personnel
    ...
    - [name=Sarah] Is the fact that we have communities with dedicated personnel not a failure point that we should mitigate, rather than special case for?
        - [name=Yuvi] yessss. We can have dedicated personnell for specific *events* but not for entire communities
