...
- A GitHub automation ([csh-sync](https://github.com/2i2c-org/csh-sync)) will automatically create a corresponding task in Asana. Updates to the title, description, hours spent, and issue status sync one-directionally from GitHub to Asana (changes made in Asana will be overwritten).
