...
This section describes our incident response process, major roles and what to expect after an incident has been mitigated.[^incident-refs][^google-sre][^acm-blog][^wikimedia-clinic-duty].
