...
2i2c establishes relationships with our customers using a service agreement. The service agreement document is based on a template developed in collaboration with 2i2c's fiscal sponsor Code for Science and Society. The agreement template includes tables that can be filled out collaboratively using Google drive with 2i2c's customer. Other tables are filled out by 2i2c to describe work plans and other terms required for 2i2c to effectively deliver value to our customer. 

The following text was added to ensure that 2i2c personnel have the required access to cloud infrastructure that may be arranged by the customer instead of through a direct relationship between 2i2c and the cloud vendor. 

>To enable 2i2c to deliver its Services, including but not limited to hub deployments, support, and maintenance for third-party managed hubs, Customer agrees to provide 2i2c technical staff with the necessary administrator-level access by furnishing login credentials linked to their 2i2c.org credentials. 2i2c will disclose the identity of technical staff working on Customer's system, but will not be able to mandate the disclosure of personal information such as passports, driving licenses, government ID or home address information for the purposes of obtaining said credentials. Customer shall designate a point of contact to facilitate access requests. Failure to grant the necessary access may result in 2i2c being unable to deliver its Services.
