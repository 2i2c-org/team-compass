...
- **Improve value delivery efficiency and effectiveness**
    ...
    - Increase operational effectiveness (cycle time from lead to delivery, cost of services or cost to deliver a project)
    - Positive contribution to community value
...
- **Healthy team function - well-being and engagement**
    ...
    - Team member onboarding effectiveness (time to first PR, etc), when we hire
...
Delivery Enablement is a support function, so we define our goals and objectives in support of other functions. 
